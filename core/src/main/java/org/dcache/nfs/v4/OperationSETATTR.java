...
public class OperationSETATTR extends AbstractNFSv4Operation {
    ...
    static void xdr2fattr(int fattr, Stat stat, Inode inode, CompoundContext context, XdrDecodingStream xdr)
        ...
        switch (fattr) {
            ...
            case nfs4_prot.FATTR4_TIME_MODIFY_SET:
                ...
                long realMtime = setMtime.set_it == time_how4.SET_TO_SERVER_TIME4 ? System.currentTimeMillis()
                        : setMtime.time.toMillis();
