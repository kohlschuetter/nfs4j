...
public class NfsServerV3 extends nfs3_protServerStub {
    ...
    private static writeverf3 generateInstanceWriteVerifier() {
        byte[] value = new byte[nfs3_prot.NFS3_WRITEVERFSIZE];
        Bytes.putLong(value, 0, System.currentTimeMillis()); // so long as we dont restart within the same
                                                                  // millisecond
        writeverf3 verf = new writeverf3(Opaque.forImmutableBytes(value));
        return verf;
    }
    ...
    public ACCESS3res NFSPROC3_ACCESS_3(RpcCall call$, ACCESS3args arg1) {
        ...
        try {
            ...
            Inode inode = Inode.forNfsHandle(arg1.object.data);
    ...
    public COMMIT3res NFSPROC3_COMMIT_3(RpcCall call$, COMMIT3args arg1) {
        ...
        try {
            Inode inode = Inode.forNfsHandle(arg1.file.data);
    ...
    public CREATE3res NFSPROC3_CREATE_3(RpcCall call$, CREATE3args arg1) {
        ...
        try {
            ...
            Inode parent = Inode.forNfsHandle(arg1.where.dir.data);
    ...
    public FSINFO3res NFSPROC3_FSINFO_3(RpcCall call$, FSINFO3args arg1) {
        ...
        try {
            Inode inode = Inode.forNfsHandle(arg1.fsroot.data);
            res.status = nfsstat.NFS_OK;
    ...
    public LINK3res NFSPROC3_LINK_3(RpcCall call$, LINK3args arg1) {
        ...
        try {
            ...
            Inode parent = Inode.forNfsHandle(arg1.link.dir.data);
            String name = arg1.link.name.value;
            checkFilename(name);

            Inode hlink = Inode.forNfsHandle(arg1.file.data);
    ...
    public LOOKUP3res NFSPROC3_LOOKUP_3(RpcCall call$, LOOKUP3args arg1) {
        ...
        try {
            Inode parent = Inode.forNfsHandle(arg1.what.dir.data);
    ...
    public READDIRPLUS3res NFSPROC3_READDIRPLUS_3(RpcCall call$, READDIRPLUS3args arg1) {
        ...
        try {
            ...
            final Inode dir = Inode.forNfsHandle(arg1.dir.data);
            ...
            while (dirList.hasNext()) {
                ...
                int newSize = ENTRYPLUS3_SIZE + name.length() + currentEntry.name_handle.handle.data.numBytes();
    ...
    public READLINK3res NFSPROC3_READLINK_3(RpcCall call$, READLINK3args arg1) {
        ...
        try {
            Inode inode = Inode.forNfsHandle(arg1.symlink.data);
    ...
    public READ3res NFSPROC3_READ_3(RpcCall call$, READ3args arg1) {
        ...
        try {
            ...
            if (res.resok.count.value.value == count) {
                res.resok.data = Opaque.forImmutableBytes(b);
            } else {
                byte[] data = new byte[res.resok.count.value.value];;
                System.arraycopy(b, 0, data, 0, res.resok.count.value.value);
                res.resok.data = Opaque.forImmutableBytes(data);
            }
    ...
    public REMOVE3res NFSPROC3_REMOVE_3(RpcCall call$, REMOVE3args arg1) {
        ...
        try {
            Inode parent = Inode.forNfsHandle(arg1.object.dir.data);
    ...
    public RENAME3res NFSPROC3_RENAME_3(RpcCall call$, RENAME3args arg1) {
        ...
        try {
            Inode from = Inode.forNfsHandle(arg1.from.dir.data);
            String file1 = arg1.from.name.value;
            checkFilename(file1);

            Inode to = Inode.forNfsHandle(arg1.to.dir.data);
    ...
    public WRITE3res NFSPROC3_WRITE_3(RpcCall call$, WRITE3args arg1) {
        ...
        try {
            ...
            VirtualFileSystem.StabilityLevel requiredStabilityLevel = VirtualFileSystem.StabilityLevel.fromStableHow(
                    arg1.stable);
            VirtualFileSystem.WriteResult ret = fs.write(inode, arg1.data.toBytes(), offset, count, requiredStabilityLevel);
